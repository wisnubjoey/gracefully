...
export default function Card() {
  ...
  return (
    ...
    <Box boxShadow='dark-lg' borderWidth='3px' borderRadius='2xl' maxWidth={5000} overflow='hidden'>
      ...
      <Image rounded="md" onClick={onOpen} src='foto2.jpg' maxH={300}  _hover={{bg: "gray.500", cursor: "pointer"}}/>
      </Flex>
      ...
      backdropBlur='2px' />
        <ModalContent>
        <Image boxShadow="dark-lg" rounded="md" src='foto2.jpg' maxW='xl' maxH='2xl' alt='Dan Abramov' />
            <ModalHeader>
                <ModalCloseButton />
            </ModalHeader>

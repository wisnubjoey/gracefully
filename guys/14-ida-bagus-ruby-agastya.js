...
export default function Card() {
  ...
  return (
    ...
    <Box borderColor="gray.100" boxShadow='dark-lg' borderWidth='3px' borderRadius='2xl' maxWidth={5000} overflow='hidden'>
      ...
      <Image rounded="md" onClick={onOpen} src='Ruby-Agastya.jpg' maxH={300}  _hover={{bg: "gray.500", cursor: "pointer"}}/>
      </Flex>

      <Modal isCentered isOpen={isOpen} onClose={onClose} size="xl" motionPreset="scale">
      ...
      backdropBlur='2px' />
        <ModalContent>
        <Image boxShadow="dark-lg" rounded="md" src='Ruby-Agastya.jpg' maxW='xl' maxH='2xl' alt='Dan Abramov' />
            <ModalHeader>
                <ModalCloseButton />
            </ModalHeader>
            ...
            <TableContainer>
                <Table variant='simple'>
                    <TableCaption>Ida Bagus Ruby Agastya</TableCaption>
                    <Thead>
                        <Tr>
                            <Th>Umur</Th>
                            <Th>Nomor Absen</Th>
